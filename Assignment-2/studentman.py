...
class Student(Person):
    ...
    def add_grade(self,subject,grade):
        if subject in self.courses:
            ...
            print(f"Cannot assign grade for {subject}. {self.name} is not enrolled in this course.")
...
class Course:
    def __init__(self,course_name,cousre_code,instructor):
        self.course_name=course_name
        self.course_code=cousre_code
